...
export default function Movies() {
    ...
    useEffect(() => {
        // Load movie genres to populate the sidebar filter
    ...
    const fetchMovies = async (pageNum, reset = false) => {
        ...
        const data = await fetchApi('/discover/movie', params);
    ...
    // Re-fetch when sort or genre filters change
    useEffect(() => {
        setPage(1);
        fetchMovies(1, true);
    }, [selectedGenre, sort, language]);

    // Infinite scroll or button trigger
    useEffect(() => {
        ...
        <div className="px-8 max-w-[1600px] mx-auto py-10 flex flex-col md:flex-row gap-12">
            ...
            <div className="w-full md:w-72 flex-shrink-0">
                <div className="bg-card border border-white/5 rounded-[32px] p-8 sticky top-28 shadow-2xl overflow-hidden group">
                    ...
                    <h2 className="text-xl font-black text-white mb-8 tracking-tight uppercase tracking-tighter">Filter Vault</h2>
                    ...
                    <div className="mb-10">
                        ...
                        >
                            ...
                            <option value="revenue.desc">All-Time Hits</option>
                        </select>
                    </div>
                    ...
                    <div>
                        <label className="block text-[10px] font-black text-textMuted uppercase tracking-[0.2em] mb-3 ml-1">Genrations</label>
            ...
            <div className="flex-1">
                <div className="flex items-center gap-4 mb-14">
                    ...
                    <h1 className="text-4xl font-black text-white tracking-tighter uppercase whitespace-nowrap">
                        Movies <span className="text-white/20 text-2xl font-black">/ Vault</span>
                    </h1>
                </div>
