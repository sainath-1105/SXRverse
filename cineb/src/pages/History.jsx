        ...
        <div className="px-8 max-w-[1600px] mx-auto py-10">
            <div className="flex items-center justify-between mb-14">
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="text-4xl font-black text-white tracking-tighter uppercase whitespace-nowrap">
                        Archives <span className="text-white/20 text-2xl font-black">/ Time Line</span>
                    </h1>
                </div>
                ...
                {history.length > 0 && (
                    ...
                    >
                        <Trash2 size={16} className="group-hover:animate-bounce" /> Wipe Archives
                    </button>
                )}
            </div>
            ...
            {history.length === 0 ? (
                <div className="bg-card/50 border border-white/5 rounded-[48px] p-24 flex flex-col items-center justify-center text-center shadow-inner mt-4 backdrop-blur-md">
                    ...
                    <h3 className="text-3xl font-black text-white mb-3 tracking-tighter uppercase">No Historical Data</h3>
                    <p className="text-textMuted max-w-sm font-bold uppercase tracking-widest text-[10px] leading-loose">Your projection logs are currently sterile. Embark on a journey to populate your temporal records.</p>
                </div>
            ) : (
